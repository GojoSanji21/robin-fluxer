...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            notification_msg = await message.reply(
                f"<b>This File is deleting automatically in {get_exp_time(FILE_AUTO_DELETE)}.. Forward in your Saved Messages..!</b>"
            )
    ...
    [
        [InlineKeyboardButton("• ᴄʟɪᴄᴋ ғᴏʀ ᴍᴏʀᴇ •", url="https://t.me/adult_flux/30")],  # URL Button (Row 1)
        [InlineKeyboardButton("• ʜᴇʟᴘ", callback_data = "help"),
                    InlineKeyboardButton('ᴀʙᴏᴜᴛ •', callback_data = "about")],  # Callback Buttons (Row 2)
        [InlineKeyboardButton("• ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴs •", url="https://t.me/adult_flux/32")]  # URL Button (Row 3)
    ]
)
